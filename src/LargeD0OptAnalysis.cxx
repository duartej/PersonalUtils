...
StatusCode LargeD0OptAnalysis::execute() 
{
    ...
    spacepoints_functions::fillSpacePointTree(sct_sp_container,prdTruthCollection,m_daughters_llp,m_current_EvtNumber,m_lightSP,m_tree);
    ...
    spacepoints_functions::fillSpacePointTree(pixel_sp_container,prdTruthCollection,m_daughters_llp,m_current_EvtNumber,m_lightSP_Pixel,m_tree_pixel);
